...
// Validate ../../../src/app/api/data/sync/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/data/sync">> = Specific
  const handler = {} as typeof import("../../../src/app/api/data/sync/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
